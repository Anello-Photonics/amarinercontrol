...
Rectangle {
    ...
    QGCFlickable {
        ...
        GridLayout {
            ...
            QGCLabel { text: qsTr("ANELLO Maritime INS Integration Manual") }
            QGCLabel {
                linkColor:          qgcPal.text
                text:               "<a href=\"https://docs-a1.readthedocs.io/en/maritime_ins/index.html\">https://docs-a1.readthedocs.io/en/maritime_ins/index.html</a>"
                onLinkActivated:    (link) => Qt.openUrlExternally(link)
            }

            QGCLabel { text: qsTr("Contact") }
            QGCLabel {
                linkColor:          qgcPal.text
                text:               "support@anellophotonics.com"
                onLinkActivated:    (link) => Qt.openUrlExternally(link)
            }
